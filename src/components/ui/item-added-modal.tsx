    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md bg-white rounded-3xl border border-border shadow-2xl overflow-hidden z-10 p-6 md:p-7 text-left"
        >
          {/* Close button */}
          <button
            onClick={closeModal}
          ...
          {/* Header Badge */}
          <div className="flex items-center gap-2.5 text-success font-semibold text-sm mb-4">
          ...
          {/* Product Details */}
          <div className="flex items-center gap-4 p-3 bg-background-secondary rounded-2xl border border-border mb-6">
            <div className="relative w-16 h-16 bg-white rounded-xl overflow-hidden shrink-0 border border-border">
              <Image
                src={
          ...
          <div className="space-y-2.5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 bg-accent hover:bg-accent-hover text-white text-sm font-semibold rounded-full shadow-md shadow-accent/20 transition-all active:scale-[0.98] cursor-pointer"
            >
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button
                onClick={closeModal}
                className="w-full py-2.5 px-4 bg-background-secondary hover:bg-border-light text-foreground-secondary hover:text-foreground text-xs font-semibold rounded-full transition-colors cursor-pointer"
              >
                Continue Browsing
              </button>
